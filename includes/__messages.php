...
<div class="Header-item mr-0 mr-md-3 flex-order-1 flex-md-order-none">
    ...
    <a aria-label="<?php echo $msg; ?>" class="Header-link notification-indicator position-relative tooltipped tooltipped-sw js-socket-channel js-notification-indicator" href="<?php echo $link; ?>">
        <span class="js-indicator-modifier mail-status <?php echo ($number_of_unread_messages>0 ? 'unread' : '') ?>"></span>
