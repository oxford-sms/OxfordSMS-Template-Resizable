        ...
        <div class="SelectMenu-modal">
            <header class="SelectMenu-header">
                ...
                <button class="SelectMenu-closeButton" type="button" aria-label="Close menu"
                        data-toggle-for="details-1f7db5aaa">
                    <svg height="16" class="octicon octicon-x" viewBox="0 0 16 16" version="1.1" width="16"
                         aria-hidden="true">
            ...
            >
                ...
                >
                    ...
                    <include-fragment class="SelectMenu-loading" aria-label="Loading">
                        <svg class="octicon octicon-octoface anim-pulse" height="32" viewBox="0 0 16 16" version="1.1"
                ...
                <div class="border-top border-gray-light position-relative">
                    <a
                        ...
                        <svg class="octicon octicon-organization SelectMenu-icon" viewBox="0 0 16 16" version="1.1"
                    ...
                    <a
                        ...
                        <svg class="octicon octicon-plus SelectMenu-icon" viewBox="0 0 16 16" version="1.1" width="16"
