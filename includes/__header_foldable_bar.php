...
// class="Header-link d-block d-md-none mr-0 mr-md-3 py-2 py-md-3 border-top border-md-top-0 border-white-fade-15" 
    ...
    <a href="/change-password" aria-label="User profile" ><div class="Header-link py-md-3  mr-0 mr-md-3 py-2 border-top border-md-top-0 border-white-fade-15">
      <img class="avatar avatar-user" src="<?php echo $avatar_image; ?>" width="20" height="20" alt="<?php echo $user->username; ?>" />User Profile: <?php echo $user->username; ?></div>
</a>
	<?php endif; */ ?>
