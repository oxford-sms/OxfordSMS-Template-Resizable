...
<div class="d-block d-md-none">
   <div class="mt-2 mb-4 Details js-repos-container mobileSideBar" id="dashboard-org-repos-box" data-pjax-container role="navigation">
      <h2 class="f4 mb-1 text-normal d-flex flex-justify-between flex-items-center"><div id="oxfordSMSPageHeader_Mobile"></div></h2>
      
	  <!--NEWS <div class="Box px-2 py-1 mb-3 pb-2"><div>-->
            ...
            <ul class="list-style-none" data-filterable-for="org-repos-filter-sm" data-filterable-type="substring">
               <li class="private source">
                  <a href="/oxford-sms/Grading"
                     ...
                     <svg class="octicon octicon-lock text-gray mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
