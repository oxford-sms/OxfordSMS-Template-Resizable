...
<a class="Header-link" href="<?php echo $dashboardlink; ?>"><div class="fusion-logo" data-margin-top="10px" data-margin-bottom="10px" data-margin-left="0px" data-margin-right="0px"><?php echo $logo; ?></div></a>
